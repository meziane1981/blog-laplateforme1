...
?>
    <p align="center">Vous devez être connecter pour pouvoir commenter ce post ! <a href="index.php?page=signin">Se connecter ?</a> ou <a href="index.php?page=register">S'inscrire ?</a></p><br/><br/><br/><br/>
<?php
}
?>